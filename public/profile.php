...
if (!$user) {
    if ($viewingSelf) {
        // If viewing own profile but user doesn't exist in DB, logout and redirect to login
        session_destroy();
        header("Location: login.php?error=account_not_found");
        exit();
    } else {
        // If viewing someone else's profile that doesn't exist, redirect to own profile
...
if ($viewingSelf && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] == 0) {
        ...
        if (in_array(strtolower($filetype), $allowed)) {
            $newFilename = "user_" . $viewedUserId . "_" . time() . "." . $filetype;
            ...
            if (move_uploaded_file($_FILES['profile_picture']['tmp_name'], $uploadPath)) {
                ...
                $picStmt->bind_param("si", $profilePicPath, $viewedUserId);
...
// Check for password update message from session
if (isset($_SESSION['password_update_message'])) {
    $message = $_SESSION['password_update_message'];
    unset($_SESSION['password_update_message']);
    unset($_SESSION['password_update_type']);
}
    ...
    <div class="menu">
        ...
        <div class="profile-container">
            ...
            <div class="dropdown-content">
                <button class="value" onclick="window.location.href='./marketplace.php?view=explore';"><img
                        src="./assets/images/exploreicon.svg" alt="Explore">Explore</button>
                <button class="value" onclick="window.location.href='../api/listings/view_listings.php';"><img
                        src="./assets/images/view_listingicon.svg" alt="View Listings">My Listings</button>
                <button class="value" onclick="window.location.href='../api/listings/create_listing.php';"><img
                        src="./assets/images/list_itemicon.svg" alt="Create Listing">List Item</button>
                <button class="value" onclick="window.location.href='./saved_listings.php';"><img
                        src="./assets/images/savedicons.svg" alt="Saved">Saved Items</button>
            </div>
        </div>
        ...
        <div class="profile-container">
            ...
            <div class="dropdown-content">
                <button class="value" onclick="window.location.href='./forum.php?view=threads';"><img
                        src="./assets/images/view_threadicon.svg" alt="Forum">View Threads</button>
                <button class="value" onclick="window.location.href='./forum.php?view=start_thread';"><img
                        src="./assets/images/start_threadicon.svg" alt="Start Thread">Start Thread</button>
                <button class="value" onclick="window.location.href='./forum.php?view=post_question';"><img
                        src="./assets/images/start_threadicon.svg" alt="Post Question">Ask Question</button>
            </div>
        </div>
        ...
        <div class="profile-container">
            ...
            <div class="dropdown-content">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    </button> <button class="value" onclick="window.location.href='../api/listings/view_listings.php';"><img
                            src="./assets/images/mylistingicon.svg" alt="Market">My Listings</button>
                    <button class="value" onclick="window.location.href='./saved_listings.php';"><img
                            src="./assets/images/savedicons.svg" alt="Saved">Saved Items</button>
                    <button class="value" onclick="window.location.href='./friends.php';"><img
                            src="./assets/images/friendsicon.svg" alt="Friends">Friends</button>
                    <button class="value" onclick="window.location.href='./logout.php';"><img
                            src="./assets/images/Log_Outicon.svg" alt="Logout">Logout</button> <?php else: ?>
                    <button class="value" onclick="window.location.href='./login.php';"><img
                            src="./assets/images/Log_Outicon.svg" alt="Login">Login</button>
                    <button class="value" onclick="window.location.href='./register.php';"><img
                            src="./assets/images/friendsicon.svg" alt="Register">Register</button>
                <?php endif; ?>
            </div>
        </div>
        ...
        <?php if (isset($_SESSION['user_id'])): ?> <a href="./chat.php" class="link">
            ...
            <div class="profile-container">
                ...
                <div class="dropdown-content">
                    <button class="value" onclick="window.location.href='./jobs.php';"><img
                            src="./assets/images/exploreicon.svg" alt="Explore">
                        Explore</button>
                    <button class="value" onclick="window.location.href='./jobs.php?action=post';"><img
                            src="./assets/images/post_job_icon.svg" alt="Create Job">
                        Post Job</button>
                    <button class="value" onclick="window.location.href='./jobs.php?action=my_applications';"><img
                            src="./assets/images/my_applications_icon.svg" alt="My Applications">
            ...
            <section id="listings" class="profile-section">
                ...
                <div class="listings-container">
                    <?php if ($listingsResult && $listingsResult->num_rows > 0): ?>
                            ...
                            <div class="listing-card">
                                ...
                                <div class="listing-details">
                                    ...
                                    <div class="listing-actions">
                                        ...
                                        <?php if ($viewingSelf): ?>
                                            <a href="../api/listings/edit_listing.php?id=<?= $listing['id'] ?>"
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <p class="no-items"><?= htmlspecialchars($user['username']) ?> hasn't posted any listings yet.</p>
                    <?php endif; ?>
                </div>
            </section>
                            ...
                            <div class="forum-post">
                                ...
                                <div class="post-meta">
                                    <span class="post-date">Posted:
                                        <?= date('M j, Y', strtotime($thread['created_at'])) ?></span>
            ...
            <section id="tradesperson" class="profile-section">
                ...
                <div class="tradesperson-container">
                    <div class="tradesperson-info">
                        ...
                        <?php else: ?>
                            <p>View <?= htmlspecialchars($user['username']) ?>'s skills, certifications, and job history.
                            </p>
                            <div class="tradesperson-actions">
                                <a href="./tradesperson_profile.php?user_id=<?= $viewedUserId ?>"
                                    class="btn btn-primary">View Tradesperson Profile</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <section id="settings" class="profile-section">
                ...
                <div class="profile-preview">
                    ...
                    <div class="preview-item">
                        ...
                        <span
                            class="preview-value"><?= !empty($user['location']) ? htmlspecialchars($user['location']) : 'Not specified' ?></span>
                    </div>
                    <div class="preview-item">
                        <span class="preview-label">Bio:</span>
                        <span
                            class="preview-value"><?= !empty($user['bio']) ? htmlspecialchars($user['bio']) : 'No bio yet.' ?></span>
                    </div>
                    <div class="preview-item">
                ...
                <form action="profile.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="profile-pic-upload">
                            <?php if (!empty($user['profile_picture'])): ?>
                                <img src="<?= htmlspecialchars($user['profile_picture']) ?>" alt="Current Profile Picture"
                                    class="current-pic">
                            <?php else: ?>
                                <img src="./assets/images/default_profile.jpg" alt="Default Profile" class="current-pic">
                            <?php endif; ?>
                    ...
                    <div class="form-group checkbox-group">
                        ...
                        <p class="help-text">You'll receive emails for forum replies, messages, and other important
                            updates.</p>
                    </div>
